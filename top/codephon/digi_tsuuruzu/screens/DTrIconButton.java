...
public class DTrIconButton extends Button {
    private final ResourceLocation icon;
    private final String name;
    private int dist = 33;

    public DTrIconButton(ResourceLocation icon, int x, int y, int w, int h, ITextComponent text, String name, IPressable action) {
        super(x, y, w, h, text, action);
        this.icon = icon;
        this.name = name;
    }

    public DTrIconButton(ResourceLocation icon, int x, int y, int w, int h, ITextComponent text, String name, IPressable action, int dist) {
        super(x, y, w, h, text, action);
        this.icon = icon;
        this.name = name;
        this.dist = dist;
